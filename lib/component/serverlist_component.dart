...
// import 'package:onicame/screen/add_server_screen.dart';
// import 'package:onicame/services/keys.dart';
// import 'package:onicame/utils/cached_network_image.dart';
...
//   @override
//   _ServerListComponentWidgetState createState() =>
//       _ServerListComponentWidgetState();
// }
...
//                 .expand(),
//             Text(serverData.name.validate().capitalizeFirstLetter(),
//                     style: primaryTextStyle(size: 14),
//                     textAlign: TextAlign.center)
//                 .expand(flex: 3),
//             cachedImage(serverData.flag.validate(),
//                     height: 50, width: 50, radius: 0)
...
//                   onPressed: () {
//                     push(AddServerScreen(updateData: serverData),
...
//                 value: serverData.premium.validate(value: false),
//                 onChanged: (bool value) {
//                   if (appStore.isTester) {
//                     toast("Test user cannot perform this action");
//                     return;
//                   }
//                   Map<String, dynamic> request = {serverKey.premium: value};

//                   serverService
//                       .updateDocument(request, serverData.uid)
//                       .then((v) {
//                     toast(
//                         "${serverData.name} server is now ${value ? 'premium' : 'free'}");
//                   }).catchError((e) {
//                     toast(e.toString());
//                   });
//                 },
...
//                       .then((v) {
//                     toast(
//                         "${serverData.name} server is now ${value ? 'active' : 'inactive'}");
//                   }).catchError((e) {
//                     toast(e.toString());
//                   });
//                 },
...
//                 if (snap.hasData)
//                   ...buildDataRow(
//                     appStore.searchString.isEmpty
//                         ? snap.data!
//                         : snap.data!
//                             .where((element) => element.name!
//                                 .toLowerCase()
//                                 .contains(appStore.searchString.toLowerCase()))
//                             .toList(),
//                   )
//               ],
//             ),
