...
class CateScreen extends StatefulWidget {
  final String cate;
  const CateScreen({Key? key, required this.cate}) : super(key: key);
...
class _CateScreenState extends State<CateScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final Stream<QuerySnapshot> _usersStream = FirebaseFirestore.instance
        .collection('products')
        .where('cate', isEqualTo: widget.cate)
        .snapshots();
    return Scaffold(
        drawer: const Drawer(
          child: Draweuser(),
...
class Userproductdetail extends StatefulWidget {
  ...
  final String pkgid;
  final int packageprice, delivery;
                        ...
                        if (snapshot.connectionState == ConnectionState.done) {
                          ...
                          return Padding(
                              ...
                              child: Column(children: [
                                ...
                                20.height,
                                Text(
                                  "Delivery Charges: ${data['prodcutdelivery']}",
                                  style: const TextStyle(
                                      fontWeight: FontWeight.bold,
                                      fontSize: 20),
                                ),
  ...
  uploadImageToStorage(PickedFile? pickedFile, String productId) async {
    ...
    return banner
        .add({
          ...
          'packageprice': widget.packageprice + widget.delivery,
          'deliveryprice': widget.delivery,
