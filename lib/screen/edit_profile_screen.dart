...
// import 'package:onicame/model/user_model.dart';
...
//             path: "profile",
//             fileName: user!.uid!,
//             extension: image!.files.first.extension!);
...
//     if (user != null) {
//       if (image != null) {
//         return Image.memory(image!.files.first.bytes!,
//             fit: BoxFit.cover, height: height, width: width);
//       } else if (user!.photoUrl != null && image == null) {
//         return cachedImage(user!.photoUrl,
//             fit: BoxFit.cover, height: height, width: width);
//       }
//     }
//     return Image.asset(appImages.placeholder_image,
//         fit: BoxFit.cover, height: height, width: width);
//   }
