...
class TermandCon extends StatefulWidget {
  ...
  @override
  _TermandConState createState() => _TermandConState();
}

class _TermandConState extends State<TermandCon> {
  CollectionReference users =
      FirebaseFirestore.instance.collection('termandcon');
...
class TermandConEdit extends StatefulWidget {
  const TermandConEdit({Key? key}) : super(key: key);

  @override
  _TermandConEditState createState() => _TermandConEditState();
}

class _TermandConEditState extends State<TermandConEdit> {
  CollectionReference users =
      FirebaseFirestore.instance.collection('termandcon');
  TextEditingController headingText = TextEditingController();
  TextEditingController DisText = TextEditingController();
